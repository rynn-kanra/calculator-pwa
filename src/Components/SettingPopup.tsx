...
import { PrinterType } from '../Model/PrinterConfig';
      ...
      return {
        ...
        content: (
          <div
            ...
            <div>
              <select class='form' disabled={!isDefault} value={o.printerType} onInput={(e) => { o.printerType = e.target?.value as PrinterType; }}>
            ...
            <div class="input-container">
              <label class="switch">
                <input
                  type="checkbox"
                  checked={o.autoConnect} onInput={(e) => { o.autoConnect = e.target.checked; }}
                />
            ...
            <div>
              <input class='form' type='number' name="max-digit" step="10" min="20" max="512" value={o.mtu} onInput={(e) => { o.mtu = Math.max(parseInt(e.target.value), 20); }} />
            </div>
            <div>Tipe cetakan text</div>
            <div>
              <select class='form' name="print-mode" value={o.textAsImage?.toString()} onInput={(e) => { o.textAsImage = e.target.value != "false"; }}>
            ...
            <div>
              <select class='form' name="image-mode" value={o.image} onInput={(e) => { o.image = e.target.value; }}>
            ...
            <div class="input-container">
              <label class="switch">
                <input
                  type="checkbox"
                  checked={o.sharePrinter} onInput={(e) => { o.sharePrinter = e.target.checked; }}
                />
                <span class="slider"></span>
              </label>
            </div>
