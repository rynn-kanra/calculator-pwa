...
var require_html2canvas = __commonJS((exports, module) => {
  ...
  (function(global, factory) {
    ...
    var Bounds = function() {
      ...
      Bounds2.prototype.add = function(x2, y3, w3, h3) {
        return new Bounds2(this.left + x2, this.top + y3, this.width + w3, this.height + h3);
      };
    ...
    var polyUint16Array$1 = function(buffer2) {
      ...
      for (var i4 = 0;i4 < length; i4 += 2) {
        bytes.push(buffer2[i4 + 1] << 8 | buffer2[i4]);
      }
      return bytes;
    };
    var polyUint32Array$1 = function(buffer2) {
      ...
      for (var i4 = 0;i4 < length; i4 += 4) {
        bytes.push(buffer2[i4 + 3] << 24 | buffer2[i4 + 2] << 16 | buffer2[i4 + 1] << 8 | buffer2[i4]);
      }
      return bytes;
    };
    ...
    var isAdjacentWithSpaceIgnored = function(a4, b, currentIndex, classTypes) {
    ...
    var isUpperCaseLetter = function(codePoint) {
      return codePoint >= A3 && codePoint <= Z;
    };
    ...
    var Tokenizer = function() {
      ...
      Tokenizer2.prototype.consumeUrlToken = function() {
        ...
        while (true) {
          ...
          if (codePoint === EOF || codePoint === RIGHT_PARENTHESIS) {
            return { type: 22, value: fromCodePoint$1.apply(undefined, value2) };
      ...
      Tokenizer2.prototype.consumeStringSlice = function(count) {
        ...
        while (count > 0) {
          ...
          value2 += fromCodePoint$1.apply(undefined, this._value.splice(0, amount));
          count -= amount;
        }
        this._value.shift();
        return value2;
      ...
      parse: function(context, value2) {
        ...
        if (value2.type === 5) {
          if (value2.value.length === 3) {
            var r4 = value2.value.substring(0, 1);
            var g2 = value2.value.substring(1, 2);
            var b = value2.value.substring(2, 3);
            return pack(parseInt(r4 + r4, 16), parseInt(g2 + g2, 16), parseInt(b + b, 16), 1);
          }
          if (value2.value.length === 4) {
            ...
            return pack(parseInt(r4 + r4, 16), parseInt(g2 + g2, 16), parseInt(b + b, 16), parseInt(a4 + a4, 16) / 255);
          }
          if (value2.value.length === 6) {
            var r4 = value2.value.substring(0, 2);
            var g2 = value2.value.substring(2, 4);
            var b = value2.value.substring(4, 6);
            return pack(parseInt(r4, 16), parseInt(g2, 16), parseInt(b, 16), 1);
          }
          if (value2.value.length === 8) {
            ...
            return pack(parseInt(r4, 16), parseInt(g2, 16), parseInt(b, 16), parseInt(a4, 16) / 255);
          }
        }
        if (value2.type === 20) {
    ...
    var pack = function(r4, g2, b, a4) {
      return (r4 << 24 | g2 << 16 | b << 8 | Math.round(a4 * 255) << 0) >>> 0;
    };
    ...
    var rgb = function(_context, args) {
      ...
      if (tokens.length === 3) {
        var _a = tokens.map(getTokenColorValue), r4 = _a[0], g2 = _a[1], b = _a[2];
        return pack(r4, g2, b, 1);
      }
      if (tokens.length === 4) {
        var _b = tokens.map(getTokenColorValue), r4 = _b[0], g2 = _b[1], b = _b[2], a4 = _b[3];
        return pack(r4, g2, b, a4);
      }
      return 0;
    };
    ...
    var hsl = function(context, args) {
      ...
      var t1 = l3 * 2 - t22;
      var r4 = hue2rgb(t1, t22, h3 + 1 / 3);
      var g2 = hue2rgb(t1, t22, h3);
      var b = hue2rgb(t1, t22, h3 - 1 / 3);
      return pack(r4 * 255, g2 * 255, b * 255, a4);
    };
    ...
    var distance = function(a4, b) {
      return Math.sqrt(a4 * a4 + b * b);
    };
      ...
      switch (gradient.size) {
        ...
        case 2:
          if (gradient.shape === 0) {
            ...
            var c3 = Math.min(Math.abs(y3), Math.abs(y3 - height)) / Math.min(Math.abs(x2), Math.abs(x2 - width));
            var _a = findCorner(width, height, x2, y3, true), cx = _a[0], cy = _a[1];
            rx = distance(cx - x2, (cy - y3) / c3);
            ry = c3 * rx;
          }
          break;
        case 1:
        ...
        case 3:
          if (gradient.shape === 0) {
            ...
            var c3 = Math.max(Math.abs(y3), Math.abs(y3 - height)) / Math.max(Math.abs(x2), Math.abs(x2 - width));
    ...
    var parseDisplayValue = function(display3) {
      switch (display3) {
        case "block":
        case "-webkit-box":
          return 2;
    ...
    var CSSParsedDeclaration = function() {
      function CSSParsedDeclaration2(context, declaration) {
        ...
        this.display = parse(context, display2, declaration.display);
    ...
    var testForeignObject = function(document2) {
      ...
      return loadSerializedSVG$1(svg).then(function(img2) {
        ...
        var data = ctx2.getImageData(0, 0, size, size).data;
        ctx2.fillStyle = "red";
        ctx2.fillRect(0, 0, size, size);
    ...
    var capitalize = function(m3, p1, p22) {
      if (m3.length > 0) {
    ...
    var DocumentCloner = function() {
      ...
      DocumentCloner2.prototype.createCanvasClone = function(canvas) {
        ...
        try {
          ...
          if (clonedCtx) {
            if (!this.options.allowTaint && ctx2) {
              clonedCtx.putImageData(ctx2.getImageData(0, 0, canvas.width, canvas.height), 0, 0);
            } else {
    ...
    var lerp = function(a4, b, t3) {
      return new Vector(a4.x + (b.x - a4.x) * t3, a4.y + (b.y - a4.y) * t3);
    };
    ...
    var CanvasRenderer = function(_super) {
      ...
      CanvasRenderer2.prototype.resizeImage = function(image2, width, height) {
        ...
        var ctx2 = canvas.getContext("2d");
        ctx2.drawImage(image2, 0, 0, image2.width, image2.height, 0, 0, width, height);
        return canvas;
      };
            ...
            switch (_b.label) {
              case 0:
                ...
                _loop_1 = function(backgroundImage3) {
                  var image2, url, _c, path, x2, y3, width, height, pattern, _d, path, x2, y3, width, height, _e, lineLength, x0, x1, y0, y1, canvas, ctx2, gradient_1, pattern, _f, path, left, top_1, width, height, position2, x2, y3, _g, rx, ry, radialGradient_1, midX, midY, f4, invF;
